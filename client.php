...
/*menu*/
 ...
 /* Style pour la section principale de la page */
        ...
        /* Style pour les étiquettes des champs du formulaire */
        label {
            font-weight: bold;
...
<body>
    ...
    <div class="container">
        ...
        <form action="#" method="post">
            ...
            <a href="achatbillets.php" class="button1">Créer Client</a>
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $requete = "INSERT INTO client (Prenom_client, Nom_client, Email_client, Adresse_client, Telephone_client, ModePaiement_client)
